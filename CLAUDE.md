...
**v0.25.0** — Python-first, no ML frameworks required for core logic. HF integration optional.
...
| `kairu/reliability.py` | Cronbach's α · ICC(2,1) · Fleiss' κ inter-rater reliability |
